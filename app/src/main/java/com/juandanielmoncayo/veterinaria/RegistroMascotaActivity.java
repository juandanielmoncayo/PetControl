...
public class RegistroMascotaActivity extends AppCompatActivity {
    ...
    private void registrarMascota() {
            ...
            if (idCombo!=0){
                ...
                Toast.makeText(getApplicationContext(),getResources().getString(R.string.id_registro)+idResultante, Toast.LENGTH_SHORT).show();
                db.close();
                Intent i = new Intent(this, Main2Activity.class );
                startActivity(i);

            }else{
                Toast.makeText(getApplicationContext(),getResources().getString(R.string.seleccione_una_opcion), Toast.LENGTH_LONG).show();
            }
